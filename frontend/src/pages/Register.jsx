...
function Register() {
  ...
  return (
    <div className="min-h-screen bg-dark-900 flex items-center justify-center p-4">
      ...
      <div className="absolute top-1/4 left-1/4 w-56 h-56 sm:w-96 sm:h-96 bg-primary-500/10 rounded-full blur-3xl" />
      <div className="absolute bottom-1/4 right-1/4 w-56 h-56 sm:w-96 sm:h-96 bg-purple-500/10 rounded-full blur-3xl" />
